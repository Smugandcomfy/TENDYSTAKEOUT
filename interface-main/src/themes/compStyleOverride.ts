  ...
  return {
      ...
      styleOverrides: {
        root: {
          ...
          "& .MuiOutlinedInput-notchedOutline": {
            borderColor:
              theme.customization.theme === "dark" ? theme.colors.textPrimary + 28 : theme.colors.lightGray200,
          },
    ...
    MuiGrid: {
      styleOverrides: {
        root: {
          "& .lightGray200": {
            ...(theme.customization.theme !== "dark" ? { backgroundColor: theme.colors.lightGray200 } : {}),
          },
          "& .lightGray50": {
            ...(theme.customization.theme !== "dark" ? { backgroundColor: theme.colors.lightGray50 } : {}),
          },
        },
      },
    },
