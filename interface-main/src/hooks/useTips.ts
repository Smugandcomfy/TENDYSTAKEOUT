...
export function useTips(): [
  (message: string, type: MessageTypes | ResultStatus, options?: TIP_OPTIONS) => TIP_KEY,
  ...
  const open = useCallback(
    (message: string, type: MessageTypes | ResultStatus, options?: TIP_OPTIONS) => {
...
export function useSuccessTip(): [(message: string, options?: TIP_OPTIONS) => TIP_KEY, (key: TIP_KEY) => void] {
...
export function useErrorTip(): [(message: string, options?: TIP_OPTIONS) => TIP_KEY, (key: TIP_KEY) => void] {
  const [openCallback, closeCallback] = useTips();
