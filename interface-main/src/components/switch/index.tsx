...
const useStyles = makeStyles((theme: Theme) => {
  const trackBorder =
    theme.customization.theme === "dark" ? `1px solid ${theme.colors.darkTextSecondary}` : "1px solid #EDE7F6";

  const trackActiveBorder =
    theme.customization.theme === "dark" ? `1px solid ${theme.colors.darkSecondaryMain}` : "1px solid #EDE7F6";
  ...
  return {
    ...
    switchBase: {
      ...
      "&$checked": {
        ...
        "& + $track": {
          backgroundColor: theme.customization.theme === "dark" ? theme.colors.darkLevel3 : "#FAFAFA",
          opacity: 1,
