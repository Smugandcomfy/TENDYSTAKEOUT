...
export type BitcoinAddress = { p2sh: Uint8Array } | { p2wpkh_v0: Uint8Array } | { p2pkh: Uint8Array };
export type BtcNetwork = { Mainnet: null } | { Regtest: null } | { Testnet: null };
export type Event =
  | {
...
export interface _SERVICE {
  ...
  get_btc_address: ActorMethod<[{ owner: [] | [Principal]; subaccount: [] | [Uint8Array] }], string>;
