export const idlFactory = ({ IDL }: any) => {
  ...
  const ResponseResult_4 = IDL.Variant({ ok: IDL.Text, err: IDL.Text });
  ...
  const Property = IDL.Record({
    ...
    expectedFundraisingPricingTokenQuantity: IDL.Text,
    settled: IDL.Opt(IDL.Bool),
    name: IDL.Text,
    extraTokenFee: IDL.Opt(IDL.Nat),
    description: IDL.Text,
    pricingTokenId: IDL.Text,
    soldQuantity: IDL.Text,
    fundraisingPricingTokenQuantity: IDL.Opt(IDL.Text),
  ...
  const TokenViewSet = IDL.Record({
    ...
    pricingToken: IDL.Record({ info: TokenInfo, transFee: IDL.Nat }),
  });
  const TokenSet = IDL.Record({
    token: TokenInfo,
  ...
  const Investor = IDL.Record({
    ...
    expectedDepositedPricingTokenQuantity: IDL.Text,
  });
  ...
  const LaunchpadCanister = IDL.Service({
    addInvestor: IDL.Func([], [BoolResult], []),
    addInvestorAddress: IDL.Func([IDL.Text], [], []),
    addInvestorFromApprove: IDL.Func([IDL.Text], [BoolResult], []),
    appendPricingTokenQuantity: IDL.Func([], [BoolResult], []),
    appendPricingTokenQuantityFromApprove: IDL.Func([IDL.Text], [BoolResult], []),
    ...
    getPricingTokenQuantity: IDL.Func([], [ResponseResult_5], ["query"]),
  ...
  const LaunchpadManager = IDL.Service({
    ...
    generateTicket: IDL.Func([IDL.Text], [ResponseResult_4], []),
    getCanisters: IDL.Func([], [ResponseResult_7], ["query"]),
    getDetail: IDL.Func([], [ResponseResult_1], ["query"]),
    getInvestorsSize: IDL.Func([], [ResponseResult_5], []),
    getLaunchpadCanisters: IDL.Func([], [IDL.Vec(LaunchpadCanister)], ["query"]),
    getPricingTokenQuantity: IDL.Func([], [ResponseResult_4], []),
    getTicketPackage: IDL.Func([IDL.Text, IDL.Text], [ResponseResult_3], ["query"]),
