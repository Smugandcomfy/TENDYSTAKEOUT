...
import { useBTCTransactions, BTCTx } from "hooks/useBTCCalls";
import { parseTokenAmount } from "utils/sdk/index";
...
function getTransactionAmountOut(transaction: BTCTx | undefined, address: string | undefined) {
...
export default function Transactions({ address, block }: { block: number | undefined; address: string | undefined }) {
