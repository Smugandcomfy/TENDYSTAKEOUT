...
import LaunchpadIcon from "assets/images/console/Launchpad.svg";
import { openInNewWindow } from "utils/sdk/index";
...
export function ConsoleItem({ label, Icon, comingSoon, path, link, title, demo, routes = [] }: Console) {
  ...
  const handleClick = () => {
    ...
    if (link) {
      openInNewWindow(link, "console_link");
      return;
    }
  ...
  const handleRouteClick = (route: Route) => {
    ...
    if (route.link) {
      openInNewWindow(route.link, "console_link");
      return;
    }
