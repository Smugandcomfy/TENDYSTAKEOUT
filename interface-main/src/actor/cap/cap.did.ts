export default ({ IDL }: any) => {
  ...
  return IDL.Service({
    ...
    get_next_canisters: IDL.Func([WithWitnessArg], [GetNextCanistersResponse], ["query"]),
    get_stable: IDL.Func([IDL.Nat64, IDL.Nat64], [IDL.Vec(IDL.Nat8)], ["query"]),
    get_stable_size: IDL.Func([], [IDL.Nat32], ["query"]),
    get_token_transactions: IDL.Func([GetTokenTransactionsArg], [GetTransactionsResponseBorrowed], ["query"]),
    get_transaction: IDL.Func([WithIdArg], [GetTransactionResponse], ["query"]),
    get_transactions: IDL.Func([GetTransactionsArg], [GetTransactionsResponseBorrowed], ["query"]),
    get_upgrade_status: IDL.Func([], [IDL.Nat64, IDL.Bool], ["query"]),
    get_user_transactions: IDL.Func([GetUserTransactionsArg], [GetTransactionsResponseBorrowed], ["query"]),
    git_commit_hash: IDL.Func([], [IDL.Text], ["query"]),
    insert: IDL.Func([IndefiniteEvent], [IDL.Nat64], []),
    insert_many: IDL.Func([IDL.Vec(IndefiniteEvent)], [IDL.Nat64], []),
