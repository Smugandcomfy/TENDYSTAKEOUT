...
import { StatusResult, PaginationResult, BigNumber, Override } from "utils/sdk/index";
...
export type HoldersRequest = BaseTokenRequest<{ offset: bigint; limit: bigint }>;
export type HoldersResult = BaseTokenResult<PaginationResult<Holder>>;
...
export type TransactionRequest = BaseTokenRequest<Override<_TransactionRequest, { capId?: string; witness?: boolean }>>;
...
export abstract class BaseTokenAdapter<T> {
  ...
  public abstract holders({ canisterId, params: HoldersRequest }: HoldersRequest): HoldersResult;
